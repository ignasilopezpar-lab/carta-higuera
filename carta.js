...
(function () {
  ...
  function estilos() {
    ...
    css.textContent = [
      ...
      '.carta-col{width:48%}',
      '.carta-titulo-grande{font-size:35px;font-weight:400;color:#B98D4B;text-align:center;margin-bottom:10px}',
      '.carta-seccion{margin-bottom:30px}',
      '.carta-titulo{font-size:30px;color:#B98D4B;font-weight:400;margin-bottom:-10px}',
